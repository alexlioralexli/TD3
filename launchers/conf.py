...
DIR_AND_MOUNT_POINT_MAPPINGS = [
    ...
    # dict(
    #     local_dir='/Users/alexli/workspace/rlkit',
    #     mount_point='/home/ubuntu/workspace/rlkit',
    #     filter_dir=['output', 'data', 'ec2_data', 'archived_data',
    #                 '/Users/alexli/workspace/rlkit/data', '/Users/alexli/workspace/rlkit/archived_data'],  # Note: Can change this!
    #     pythonpath=True,
    # )
]
...
# AWS_S3_PATH = 's3://bucket/directory  # doodad one should be fine

# The docker image is looked up on dockerhub.com.
DOODAD_DOCKER_IMAGE = "'vitchyr/railrl_v9_cuda10-1_mj1-50-1-59_torch0-4-1_gym0-10-5_py3-5-2'"  #"'iclavera/meta-mb'" #"'vitchyr/railrl-vitchyr'"
...
try:
    from .conf_private import *
except ImportError:
    print("No personal conf_private.py found.")
print(DOODAD_DOCKER_IMAGE)
